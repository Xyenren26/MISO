...
class MessagesController extends Controller
{
    ...
    public function getContacts(Request $request)
    {
        ...
        ->groupBy('users.employee_id','users.id','users.name', 'users.first_name', 'users.last_name', 'users.email','users.email_verified_at'
        ,'users.password', 'users.account_type', 'users.phone_number','users.department','users.status','users.is_first_login' ,'users.last_activity'
        ,'users.remember_token','users.session_id','users.created_at','users.updated_at','users.active_status','users.avatar'
        ,'users.dark_mode','users.messenger_color','is_assigned')
